...
- `stacks/aws-core/`: AWS application stacks (`sqs`, `dynamodb`); each subfolder is a separate Terraform root
- `stacks/oci-core/`: OCI stacks split by resource (`network`, `oke`)
